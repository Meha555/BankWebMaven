...
<div>
    ...
    <div id="main">
        ...
        <hr class="xuxian">
        <form action="/BankWebMaven_war/personal_info_update.jsp" method="post"><!--又是路径的问题！！！！-->
            <table border="4" align="center" width="100%" height="70%">
                ...
                <tr>
                    <%--<td name="cid"><%=request.getAttribute("cid")%></td>
                    <td name="card_id"><%=request.getAttribute("card_id")%></td>
                    <td name="pwd"><%=request.getAttribute("pwd")%></td>--%>
                        <td name="cid"><%=session.getAttribute("cid")%></td>
                        <td name="card_id"><%=session.getAttribute("card_id")%></td>
                        <td name="pwd"><%=session.getAttribute("pwd")%></td>
                </tr>
                <tr>
                    <td colspan="3">
