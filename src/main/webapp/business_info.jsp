...
<div>
    ...
    <div id="main">
        ...
        <hr class="xuxian">
        <ul>
            <li><a href="BusinessServlet/showAllBusiness">1️⃣ 查询业务/Inquiry business🔥🔥🔥</a></li>
            <li><a href="WindowServlet/showAllWindow">2️⃣ 查询窗口/Query window🔥🔥🔥</a></li>
            <li><a href="get_number.jsp">3️⃣ 排队取号/Take a number🔥🔥🔥</a></li>
            <li><a href="#">4️⃣ 查询存款/Query deposit</a></li>
            <li><a href="#">5️⃣ 业务咨询/Business Consulting</a></li>
        </ul>
    </div>
    <div id="footer">
