...
<div>
    ...
    <div id="main">
        <h2>排队取号/Take a number</h2>
        <hr class="xuxian">
        <form action="CustomerServlet/getNumber" method="post">
            <table border="4" align="center" width="100%" height="70%">
                <tr>
                    <th>卡号：</th>
                    <td><%=session.getAttribute("card_id")%></td>
                </tr>
                <tr>
                    <th>要办理的业务：</th>
                    <td>
                        <select id="business" name="bnumber">
                            <option value="00001" selected>取款</option>
                            <option value="00002">存款</option>
                            <option value="00003">贷款</option>
                            <option value="00004">查询</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <input class="btn" type="submit" value="点击取号"/>
                    </td>
                </tr>
            </table>
        </form>
